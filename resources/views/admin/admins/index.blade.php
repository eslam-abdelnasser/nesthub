        ...
        <div class="col-lg-8">
            <div class="card-box">
                <div class="row">
                    ...
                    <div class="col-sm-4" >
                        <a href="{{route('admin.create')}}" class="btn btn-default btn-md waves-effect waves-light m-b-30" data-animation="fadein" data-plugin="custommodal"
                           data-overlaySpeed="200" data-overlayColor="#36404a"><i class="md md-add"></i> Add Admin</a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover mails m-0 table table-actions-bar">
                        ...
                        @foreach($admins as $admin)
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{asset('uploads/admins/'. $admin->image_url  )}}" alt="contact-img" title="contact-img" class="img-circle thumb-sm" />
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{route ('admin.edit',$admin->id)}}" class="table-action-btn">
                                            <i class="md md-edit"></i>
                                        </a>
                                        <a href="{{route ('admin.destroy',$admin->id)}}" class="table-action-btn">
